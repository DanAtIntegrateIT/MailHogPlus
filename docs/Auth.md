...
You can use a MailHogPlus shortcut to generate a bcrypted password:

    MailHogPlus bcrypt <password>

### Enabling HTTP authentication

To enable authentication, pass an `-auth-file` flag to MailHogPlus:

    MailHogPlus -auth-file=docs/example-auth
